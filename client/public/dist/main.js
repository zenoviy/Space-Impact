...
function transformMenuData(data) {
    if (!data)
        throw Error("No data to transform");
    var obj = { soundLevel: null, soundOn: null };
    for (var _i = 0, data_1 = data; _i < data_1.length; _i++) {
        var item = data_1[_i];
        if (item.name && item.value) {
...
function gameDataInit(PlayerShip) {
    return __awaiter(this, void 0, void 0, function () {
        var gameField, gameActionField, gameUIfield, level, shipType, shipLife, res, levelData, levelObjects, grappleObjects, gameSetings, userData, enemyData, shipData;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
...
function mapRanomObjectSpawn(levelObjects, SideObject, allGameSideObjects) {
    return __awaiter(this, void 0, void 0, function () {
        function mapObjectSpawner(levelObjects, SideObject, allGameSideObjects) {
            return __awaiter(this, void 0, void 0, function () {
                var gameData, levelData, spawnProbability, context, screenData, levelObjectProps, yPosition, extraObjects, _a, explosionData, sideObject_1;
                var _this = this;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
...
(function init() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        var wrapper, mainMenu, gameState, navigation_1, gameObject, playerShipData, engine, contexts, navigation, levelSound;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 2:
                    ...
                    levelSound = gameObject.createSound(constructors.SoundCreator);
                    return [2 /*return*/];
            }
        });
    });
